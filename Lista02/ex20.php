...
<html lang="en">
  ...
  <body>
    <div class="container">
      <h1 class="mt-5">Cálculo de Velocidade Média</h1>
      <form method="post" action="ex20resposta.php">
        <div class="mb-3">
        ...
        <div class="mb-3">
          <label for="tempo" class="form-label">Insira o tempo gasto (em horas):</label>
