...
<html lang="en">
  ...
  <body class="d-flex flex-column justify-content-center align-items-center min-vh-100">
     ...
     <form method="post" action="exer03resposta.php" class="border w-50 p-3">
        ...
        <?php for($i=0; $i<=4; $i++): ?>
          ...
          <div class="mb-3">
            ...
            <input type="text" id="codigo" name="codigo[]" class="form-control" placeholder="Informe o código" required="">
          </div>
